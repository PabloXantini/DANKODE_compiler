...
- [CompilerTask.java](https://github.com/PabloXantini/DANKODE_compiler/tree/main/src/dankcompiler/CompilerTask.java): This is the basic API interface for the compiler, you must include only this file for use the language.
